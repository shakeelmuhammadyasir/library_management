...
public class BookMongoRepositoryTest {
	...
	public void testFindAllBooks_WithData() {
		// Given
		Document doc1 = new Document("id", 1).append("serialNumber", "SN001").append("name", "Java Programming")
				.append("authorName", "Author A").append("genre", "Programming").append("isAvailable", true);

		Document doc2 = new Document("id", 2).append("serialNumber", "SN002").append("name", "Data Structures")
				.append("authorName", "Author B").append("genre", "Computer Science").append("isAvailable", false);
