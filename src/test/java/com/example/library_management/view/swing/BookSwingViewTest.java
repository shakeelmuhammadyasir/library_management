...
class BookSwingViewTest {
    ...
    void testAddBookButtonWithValidData() {
        ...
        Mockito.verify(libraryControllerMock)
                .newBook(Mockito.argThat(book -> book.getId() == 1 
                        && "SN123".equals(book.getSerialNumber())
                        && "Book Name".equals(book.getName()) 
                        && "Author".equals(book.getAuthorName())
    ...
    void testDeleteBookButtonWithBookSelected() {
        ...
        // Then
        Mockito.verify(libraryControllerMock).deleteBook(book);
    }
    ...
    void testShowAllBooks() {
        ...
        List<Book> books = Arrays.asList(
                new Book(1, "SN123", "Book 1", "Author 1", "Genre 1", true),
