...
public class Book {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(id, other.id) && Objects.equals(serialNumber, other.serialNumber)
				&& Objects.equals(name, other.name) && Objects.equals(authorName, other.authorName)
				&& Objects.equals(genre, other.genre) && isAvailable == other.isAvailable;
	}

	@Override
	public String toString() {
		return "Book [id=" + id + ", serialNumber=" + serialNumber + ", name=" + name + ", authorName=" + authorName
